      ...
      (set, get) => ({
        ...
        renameNode: (id, label) =>
          set({
            nodes: get().nodes.map((n) =>
              n.id === id
                ? ({ ...n, data: { ...n.data, label } } as typeof n)
                : n,
            ),
          }),
        duplicateNode: (id) => {
        ...
        addGroup: () => {
          ...
          const newGroup = {
            ...
            position: {
              x: 160 + groupIdCounter * 20,
              y: 60 + groupIdCounter * 20,
            },
        ...
        insertTemplate: (template: Template) => {
          ...
          const newEdges: Edge<TopologyEdgeData>[] = template.edges.map(
            (te) => ({
        ...
        addNote: () => {
          ...
          const newNote = {
            ...
            type: "note",
            position: {
              x: 200 + noteIdCounter * 20,
              y: 400 + noteIdCounter * 20,
            },
